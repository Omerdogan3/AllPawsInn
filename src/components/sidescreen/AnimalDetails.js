		...
		if (Array.isArray(this.props.animal) && this.props.animal.length > 0){
			return  (
				<div className = "box animalDet">
					...
					Animal Name: <b>{this.props.animal[0].AnimalName}</b> <br/>
					Client Name: <b>{this.props.animal[0].FirstName} {this.props.animal[0].LastName}</b> <br/>
					Breed: <b>{this.props.animal[0].Breed}</b> <br/>
					Sex: <b>{this.props.animal[0].Sex}</b> <br/>
					Age: <b>{this.props.animal[0].Age}</b> <br/><br/>
